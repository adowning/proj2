// SlotSettings.ts - FruitShopNET game specific settings
...
export class SlotSettings extends BaseSlotSettings {
    ...
    private initializeFromGameState(gameStateData: ISlotSettingsData): void {
        ...
        this.MaxWin = this.shop?.max_win ?? 0; // Default 0 if not set, strict check
        this.increaseRTP = 1;
        ...
        this.Paytable = {
            'SYM_1': [0, 0, 0, 0, 0, 0],
            'SYM_2': [0, 0, 0, 0, 0, 0],
            'SYM_3': [0, 0, 5, 25, 300, 2000],
            'SYM_4': [0, 0, 0, 25, 150, 1000],
            'SYM_5': [0, 0, 0, 20, 125, 750],
            'SYM_6': [0, 0, 0, 20, 100, 500],
            'SYM_7': [0, 0, 0, 15, 75, 200],
            'SYM_8': [0, 0, 0, 15, 50, 150],
            'SYM_9': [0, 0, 0, 10, 25, 100],
            'SYM_10': [0, 0, 0, 5, 20, 75],
            'SYM_11': [0, 0, 0, 5, 15, 60],
            'SYM_12': [0, 0, 0, 5, 10, 50]
        };
