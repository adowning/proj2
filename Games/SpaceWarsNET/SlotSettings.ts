...
export class SlotSettings extends BaseSlotSettings {
    ...
    private initializeFromGameState(gameStateData: ISlotSettingsData): void {
        ...
        this.Paytable = {
            ...
            'SYM_3': [0, 0, 0, 20, 125, 400],
            'SYM_4': [0, 0, 0, 15, 75, 200],
            'SYM_5': [0, 0, 0, 10, 60, 175],
            'SYM_6': [0, 0, 0, 10, 50, 150],
            'SYM_7': [0, 0, 0, 10, 40, 125],
            'SYM_8': [0, 0, 0, 4, 20, 60],
            'SYM_9': [0, 0, 0, 4, 20, 50],
            'SYM_10': [0, 0, 0, 3, 15, 40],
            'SYM_11': [0, 0, 0, 2, 15, 40],
            'SYM_12': [0, 0, 0, 2, 15, 40]
        };
